...
Test case: \texttt{test\_load\_settings\_accepts\_empty\_calendar\_paths} \\
(\texttt{tests/test\_config.py:8}).
...
Setting \texttt{commodity: null} evaluates all contracts (multi-commodity mode). \\
Test: \texttt{tests/test\_quality.py}.
...
\begin{table}[H]
\centering
\begin{tabular}{p{0.27\textwidth}p{0.15\textwidth}rrr}
\toprule
...
\begin{longtable}{p{0.32\textwidth}p{0.12\textwidth}p{0.46\textwidth}}
\toprule
...
\begin{longtable}{p{0.35\textwidth}p{0.12\textwidth}p{0.43\textwidth}}
\toprule
\textbf{Function} & \textbf{Line} & \textbf{Description} \\
\midrule
...
\begin{longtable}{p{0.40\textwidth}p{0.12\textwidth}p{0.38\textwidth}}
\toprule
\textbf{Function} & \textbf{Line} & \textbf{Description} \\
\midrule
...
\begin{longtable}{p{0.39\textwidth}p{0.12\textwidth}p{0.39\textwidth}}
\toprule
\textbf{Function} & \textbf{Line} & \textbf{Description} \\
\midrule
...
\begin{longtable}{p{0.44\textwidth}p{0.12\textwidth}p{0.34\textwidth}}
\toprule
\textbf{Function} & \textbf{Line} & \textbf{Description} \\
\midrule
